...
clean-Core-2f-Src-2f-tests:
	-$(RM) ./Core/Src/tests/bigToLittleEndian.cyclo ./Core/Src/tests/bigToLittleEndian.d ./Core/Src/tests/bigToLittleEndian.o ./Core/Src/tests/bigToLittleEndian.su ./Core/Src/tests/led_soft_test.cyclo ./Core/Src/tests/led_soft_test.d ./Core/Src/tests/led_soft_test.o ./Core/Src/tests/led_soft_test.su ./Core/Src/tests/main.cyclo ./Core/Src/tests/main.d ./Core/Src/tests/main.o ./Core/Src/tests/main.su ./Core/Src/tests/structs.cyclo ./Core/Src/tests/structs.d ./Core/Src/tests/structs.o ./Core/Src/tests/structs.su
