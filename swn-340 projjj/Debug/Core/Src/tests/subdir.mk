...
clean-Core-2f-Src-2f-tests:
	-$(RM) ./Core/Src/tests/hw4.cyclo ./Core/Src/tests/hw4.d ./Core/Src/tests/hw4.o ./Core/Src/tests/hw4.su ./Core/Src/tests/main.cyclo ./Core/Src/tests/main.d ./Core/Src/tests/main.o ./Core/Src/tests/main.su ./Core/Src/tests/reader.cyclo ./Core/Src/tests/reader.d ./Core/Src/tests/reader.o ./Core/Src/tests/reader.su ./Core/Src/tests/systick.cyclo ./Core/Src/tests/systick.d ./Core/Src/tests/systick.o ./Core/Src/tests/systick.su ./Core/Src/tests/timer.cyclo ./Core/Src/tests/timer.d ./Core/Src/tests/timer.o ./Core/Src/tests/timer.su
